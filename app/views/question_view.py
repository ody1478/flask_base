...
def _list():
    ...
    # paginate을 사용하면 Pagenation 객체가 반환된다
    # Pagination 속성 -> items, total, per_page, page, iter_pages, prev_num, next_num, has_prev, has_next
...
def vote(question_id):
    ...
    if g.user == _question.user:
        ...
        # 다대다 괸계이므로 append 함수로 추천인을 추가해야 한다
